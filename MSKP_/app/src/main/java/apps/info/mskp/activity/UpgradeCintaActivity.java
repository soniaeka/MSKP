...
public class UpgradeCintaActivity extends ActionBarActivity {

    private Button btncinta;
    private ProgressDialog pDialog;

    EditText pin_trx;
    AQuery aq;
    String success ,messages,pin;
    SessionManager session;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_upgrade_cinta);

        btncinta=(Button)findViewById(R.id.btnValidasi);
        ...
        btncinta.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void asyncJson() {
        pDialog.show();
        String url = AppConfig.SERVER+"json/upgradecinta_json.php";
    ...
    public void asyncJson2() {
        pDialog.show();
        String url = AppConfig.SERVER+"json/pincinta_json.php";
        Map<String, Object> params = new HashMap<>();
        params.put("id_member", session.getMember());
        aq.ajax(url, params, JSONObject.class, new AjaxCallback<JSONObject>() {
            @Override
